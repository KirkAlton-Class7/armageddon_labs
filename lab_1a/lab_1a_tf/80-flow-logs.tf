...
resource "aws_flow_log" "vpc" {
  ...
  log_destination = aws_cloudwatch_log_group.vpc_flow_log.arn #CloudWatch doesn't require log_destination_type (other destinations require it).
  traffic_type    = "ALL"
...
resource "aws_flow_log" "private_data_a_subnet" {
  ...
  log_destination = aws_cloudwatch_log_group.private_data_subnet_flow_log.arn #CloudWatch doesn't require log_destination_type (other destinations require it).
  traffic_type    = "ALL"
