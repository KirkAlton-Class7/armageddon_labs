...
# DONE Update references to database values with tf-state reads (Tokyo)
# db_identifier = data.terraform_remote_state.tokyo.outputs.db_identifier
# db_secret_arn = data.terraform_remote_state.tokyo.outputs.db_secret_arn

# data.terraform_remote_state.tokyo.outputs.db_secret_arn
# data.terraform_remote_state.tokyo.outputs.db_identifier