    ...
    widgets = concat([
      ...
      },
      {
        ...
        properties = {
          ...
          alarms = [
            aws_cloudwatch_metric_alarm.rds_app_to_lab_mysql_connection_failure.arn
          ]
        }
      },
      {
        ...
        properties = {
          ...
          alarms = [
            aws_cloudwatch_metric_alarm.alarm_lab_mysql_auth_failure.arn
          ]
        }
      }

    ], var.rds_app_waf_name != null ? [
